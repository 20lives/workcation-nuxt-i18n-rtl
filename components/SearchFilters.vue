  ...
  <section class="bg-gray-800 xl:w-72">
    <div class="flex justify-between px-4 py-3 xl:hidden">
      <div class="relative max-w-xs w-full">
        ...
        <input class="block w-full bg-gray-900 focus:outline-none focus:bg-white focus:text-gray-900 text-white rounded-lg ps-10 pe-4 py-2" placeholder="Search by keywords">
      </div>
      <button type="button" class="ms-4 inline-flex items-center hover:bg-gray-600 focus:outline-none focus:shadow-outline rounded-lg shadow ps-3 pe-4"
        @click="toggle"
      ...
      >
        ...
        <span class="ms-1 text-white font-medium">Filters</span>
      </button>
    </div>
        ...
        <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 lg:border-l xl:w-full">
          ...
          <div class="sm:flex sm:-mx-2 sm:flex-wrap">
            ...
            <label class="mt-3 flex items-center sm:w-1/2 sm:px-2 lg:w-full">
              ...
              <span class="ms-2 text-white">Air conditioning</span>
            </label>
          </div>
        </div>
      </div>
      <div class="bg-gray-900 px-4 py-4 sm:text-end">
