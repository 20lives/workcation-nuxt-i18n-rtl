  ...
  <header class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
    ...
    <nav class="sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between" :class="{ 'hidden': !isOpen, 'block': isOpen }">
      <div class="hidden xl:block xl:relative xl:max-w-xs xl:w-full">
        ...
        <input class="block w-full border border-transparent bg-gray-200 focus:outline-none focus:bg-white focus:border-gray-300 text-gray-900 rounded-lg ps-10 pe-4 py-2" placeholder="Search by keywords">
      </div>
      <LanguageSwitcher />
      <div class="sm:flex sm:items-center">
        <div class="px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:space-s-2 sm:border-b-0 sm:py-0 sm:px-0">
          ...
          <a href="#" class="mt-1 block px-3 py-1 rounded font-semibold text-white hover:bg-gray-800 sm:mt-0 sm:text-sm sm:px-2 xl:text-gray-900 xl:hover:bg-gray-200">Trips</a>
          <a href="#" class="mt-1 block px-3 py-1 rounded font-semibold text-white hover:bg-gray-800 sm:mt-0 sm:text-sm sm:px-2 xl:text-gray-900 xl:hover:bg-gray-200">Messages</a>
        </div>
