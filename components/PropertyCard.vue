    ...
    <div class="relative px-4 -mt-16">
      <div class="bg-white rounded-lg px-4 py-4 shadow-lg">
        <div class="flex items-baseline">
          ...
          <div class="ms-2 text-xs text-gray-600 font-semibold uppercase tracking-wide">
        ...
        <div class="mt-1">
          ...
          <span class="ms-1 text-sm text-gray-600">/wk</span>
        </div>
        <div class="mt-2 flex items-center text-sm text-gray-600">
          ...
          <span class="ms-2">{{ property.reviewCount }} reviews</span>
        </div>
      </div>
    </div>
  </div>
